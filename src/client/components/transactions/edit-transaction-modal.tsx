...
import AutogrowingTextarea from "@/client/components/common/autogrowing-textarea";
import { currencies, type Currency } from "@/client/hooks/currencies";
...
import CurrencySelect from "@/client/components/wallets/wallet-select";
