...
import {
  ...
  ModalHeader,
  ModalTitle,
} from "@/client/components/common/modal";
import { Button } from "@/client/components/ui/button";
import { Input } from "@/client/components/ui/input";
import { Label } from "@/client/components/ui/label";
import { Switch } from "@/client/components/ui/switch";
import CurrencySelect from "@/client/components/common/currency-select";
import { Skeleton } from "@/client/components/ui/skeleton";
import DeleteButton from "@/client/components/ui/delete-button";
...
import AddonInput from "@/client/components/common/addon-input";
import { IconPicker, type IconName } from "@/client/components/ui/icon-picker";
      ...
      if (id && walletData) {
        dispatch({
          ...
          payload: {
            ...
            balance: walletData.balance != null ? Number(walletData.balance) : null,
            isSavingAccount: walletData.isSavingAccount ?? false,
            savingAccountGoal: walletData.savingAccountGoal != null ? Number(walletData.savingAccountGoal) : null,
