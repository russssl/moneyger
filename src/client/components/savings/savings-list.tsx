...
import WalletItem from "@/client/components/wallets/wallet-item";
        ...
        {savingsWallets.map((wallet) => (
          <Card
            ...
            className={cn(
              ...
              Number(wallet.savingAccountGoal ?? 0) > 0 && Number(wallet.balance) >= Number(wallet.savingAccountGoal ?? 0) && "border-green-500/30"
            )}
          >
